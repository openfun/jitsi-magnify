export const MutedIcon = (): JSX.Element => (
...
export const ScreenSharingOnIcon = () =>
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" width={24} height={24} strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.348 14.652a3.75 3.75 0 0 1 0-5.304m5.304 0a3.75 3.75 0 0 1 0 5.304m-7.425 2.121a6.75 6.75 0 0 1 0-9.546m9.546 0a6.75 6.75 0 0 1 0 9.546M5.106 18.894c-3.808-3.807-3.808-9.98 0-13.788m13.788 0c3.808 3.807 3.808 9.98 0 13.788M12 12h.008v.008H12V12Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
    </svg>

export const ScreenSharingOffIcon = () =>
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" width={24} height={24} strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
...
export const RemoveUserIcon = () =>
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" width={24} height={24} strokeWidth={1.5} stroke="red" className="w-6 h-6">
...
export const TickIcon = () =>
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" width={24} height={24} stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
